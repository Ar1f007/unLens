  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col w-full lg:w-8/12">
        <h1 className="text-3xl lg:text-4xl font-bold">Reset Your password</h1>
        <p>Enter your email address here and we will send you a password reset link.</p>
        {error && <p>{splitErrorText(error.message)}</p>}
